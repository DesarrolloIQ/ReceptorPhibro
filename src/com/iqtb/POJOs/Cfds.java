...
public class Cfds  implements java.io.Serializable {
     ...
     private ArchivosSincronizacion archivosSincronizacion;
    ...
    public Cfds(Integer idCfd,String serie,Long folio, String estado,String uuid,String tipoCfd,BigDecimal total,Date fecha,Date generationDate) {
        this.idCfd=idCfd;
        this.serie=serie;
        this.folio=folio;
        this.estado=estado;
    ...
    public Cfds(Sucursales sucursalesByIdSucursal, TiposCfd tiposCfd, Clientes clientes, Date fecha, BigDecimal subtotal, BigDecimal descuento, BigDecimal total, Date fechaModificacion, Date generationDate) {
    ...
    public Cfds(Sucursales sucursalesByIdSucursal, Sucursales sucursalesByImprimirEn, ArchivosSincronizacion archivosSincronizacion, TiposCfd tiposCfd, Clientes clientes, String serie, Long folio, String uuid, Date fecha, Long numeroAprobacion, Integer anioAprobacion, BigDecimal subtotal, BigDecimal descuento, BigDecimal total, String tipoMoneda, BigDecimal tipoCambio, BigDecimal iva, String estadoFiscal, String estado, Date fechaCancelacion, Date fechaModificacion, Boolean tienePdf, String estadoImpresion, Integer idDireccion, Integer idPlantilla, String tipoCfd, String pedimento, String fechaPedimento, String aduana, Date generationDate, String ticket, Integer idConfiguracion, String cadenaOriginal, String estadoContable, Date fechaVencimiento, String rfcEmisor, String rfcReceptor, Set xmlses) {
       this.sucursalesByIdSucursal = sucursalesByIdSucursal;
       this.sucursalesByImprimirEn = sucursalesByImprimirEn;
       this.archivosSincronizacion = archivosSincronizacion;
       this.tiposCfd = tiposCfd;
       this.clientes = clientes;
       this.serie = serie;
       this.folio = folio;
    ...
    public ArchivosSincronizacion getArchivosSincronizacion() {
        return this.archivosSincronizacion;
    }
    
    public void setArchivosSincronizacion(ArchivosSincronizacion archivosSincronizacion) {
        this.archivosSincronizacion = archivosSincronizacion;
    }
